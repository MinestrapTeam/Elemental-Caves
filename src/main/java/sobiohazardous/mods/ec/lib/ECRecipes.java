...
public class ECRecipes
{
	public static void init()
	{
		...
		GameRegistry.addRecipe(new ItemStack(ECItems.hoeFreezium), new Object[] { "MM ", " S ", " S ", 'S', Items.stick, 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.pickaxeFreezium), new Object[] { "MMM", " S ", " S ", 'S', Items.stick, 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.swordFreezium), new Object[] { "M", "M", "S", 'S', Items.stick, 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.shovelFreezium), new Object[] { " M ", " S ", " S ", 'S', Items.stick, 'M', ECItems.iceGem });
		
		GameRegistry.addRecipe(new ItemStack(ECItems.helmetFreezium), new Object[] { "MMM", "M M", 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.chestplateFreezium), new Object[] { "M M", "MMM", "MMM", 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.leggingsFreezium), new Object[] { "MMM", "M M", "M M", 'M', ECItems.iceGem });
		GameRegistry.addRecipe(new ItemStack(ECItems.bootsFreezium), new Object[] { "M M", "M M", 'M', ECItems.iceGem });
